...
from cns_obsidian.datasets import LLaVAMedDataModule
...
hyperparameters = {
    ...
    "num_workers": 16,
    # saving the model
    "checkpoints_dir": "/gpfs/data/oermannlab/users/alyaka01/checkpoints/obsidian/stage_2_05_10",
    # loading the model
    ...
    "checkpoint_path": "/gpfs/data/oermannlab/users/alyaka01/checkpoints/obsidian/stage_1_05/checkpoint_4.pt",
}
...
def main():
    ...
    if dist.get_rank() == 0:
        wandb.init(
            entity="alyakin314",
            project="obsidian-stage-2-med-finetune",
    ...
    datamodule = LLaVAMedDataModule(
        "/gpfs/data/oermannlab/public_data/llava-med-data",
        processor,
